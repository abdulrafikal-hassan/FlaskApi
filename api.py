'''
This Tutorial is from the main Docs page of Flask-RESTful API
...
TODOS = {
    ...
    'todo2': {'task': 'Don\t Know what to say'},
    'todo3': {'task': 'Work Hard to Work Smart!'},
}
...
# Actuallly setup the Api resource routing here 
